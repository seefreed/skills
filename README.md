...
A small collection of AI skills for translation and media workflows. Each skill is self-contained and documented in its own `SKILL.md` file.
...
## Notes
- External dependencies are only required for `youtube-smart-edit` (e.g., `yt-dlp`, `ffmpeg`).
